/**
 * Device authorisation (RFC 8628) — the browser half of `aa login`.
 *
...
import { ApiError, device, getSession, signIn } from '../lib/api'
...
export default function DevicePanel({ copy }: Props) {
  ...
  return (
    <>
      ...
      {phase === 'out' && (
        <>
          <p className="aa-lede">{txt.signInFirst}</p>
